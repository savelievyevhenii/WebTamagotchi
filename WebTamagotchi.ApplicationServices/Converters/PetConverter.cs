...
public static class PetConverter
{
    ...
    {
        Id = pet.Id, Name = pet.Name, Level = pet.Level, ExpToLevelUp = pet.ExpToLevelUp, Dirtiness = pet.Dirtiness, Bore = pet.Bore,
        Hunger = pet.Hunger, Tiredness = pet.Tiredness, Owner = pet.Owner
    };
    
    public static Pet ToModel(PetDto dto) => new Pet
    {
        Id = dto.Id, Name = dto.Name, Level = dto.Level, ExpToLevelUp = dto.ExpToLevelUp, Dirtiness = dto.Dirtiness, Bore = dto.Bore,
